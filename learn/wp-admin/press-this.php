...
if ( !empty($_REQUEST['ajax']) ) {
	...
	case 'photo_js': ?>
		...
		for (i = 0; i < my_src.length; i++) {
			...
			maybeappend = '<a href="press-this.php?ajax=photo_thickbox&amp;i=' + encodeURIComponent(img.src) + '&amp;u=<?php echo urlencode($url); ?>&amp;height=400&amp;width=500" title="" class="thickbox"><img src="' + img.src + '" ' + img_attr + '/></a>';
